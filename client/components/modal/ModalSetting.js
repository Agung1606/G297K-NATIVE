...
export default function ModalSetting({ goToEditProfileScreen, closeModal }) {
    ...
    <View className="px-2">
      ...
      <View className="mt-4">
        <TouchableOpacity onPress={handleGoToProfileScreen}>
          <View className="flex-row justify-between items-center bg-gray-200 p-2 mb-3 rounded-lg">
